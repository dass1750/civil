...
<head>
    ...
    <meta name="description" content="Technocruise is the pre-festival Zonal round event of Techkriti which comprises of Preliminary rounds of some major competitions and professional technical workshops to enhance the learning of students and to encourage the zeal of the participants.">
    <meta name="author" content="">
        <link rel="shortcut icon" type="image/x-icon" href="tab-logo.png">
    <meta property="og:image" content="assets/img/workshop/techy.jpg" />
...
<div class='butts' id='resend_submit'>Submit</div>
 ...
 <div id='abcd' data='0.html' class="dropdown">
    <a class="dropbtn" id='just_check' href="">
    <?php
    ...
    <div class="">
      ...
      <a style='color:black' id='logout' ></a>
        ...
        <header id="myCarousel" class="carousel slide carousel-fade intro-slider">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <div class="fill" style="background-image:url('assets/img/workshop/techy.jpg');"></div>
                </div>
                <!-- <div class="item">
          ...
          <div class="container" style="width: 90%;">
            <div class="row">
              <div class="col-lg-12 text-center" data-scrollreveal="move 0">
                        <h2 class='glows'>WORKSHOP</h2>
                        <hr class="primary">
                    </div>
                </div>
                <div class="row" data-scrollreveal="enter bottom">
                  <div class="isotope">
                        <div id="iarc" class="bounce animated col-md-offset-2 col-sm-6 col-xs-6 col-md-4 portfolio-item graphic work" style=" box-shadow: 0px 7px 34px 6px;">
                            <a target="_blank" href="#" class=""  data-toggle="modal" data-target="#myModal11">
                                <img src="img/work2.jpg" class="img-centered" alt="" style="">
                                                                <div class="mob caption">
                                    <h3 style="color:black;background-color:brown;display: flex; flex-direction: column;justify-content: center;  font-family: verdana;"><span>SUPPORT SYSTEM ON DEEP EXCAVATION AND UNDERGROUND STRUCTURES</span> </h3>                                    
                                </div>
                            </a>
                        </div>
                        <div id="man" class="bounce animated col-sm-6 col-xs-6 col-md-4 portfolio-item graphic work" style="    box-shadow: 0px 7px 34px 6px;">
                            <a target="_blank" href="#" class=""  data-toggle="modal" data-target="#myModal22">
                                <img src="img/work1.jpg" class="img-centered" alt="" style="width:100%;">
                                                                <div class="mob caption" style="width:100%;">
                                    <h3 style="color:black;background-color: brown;display: flex; flex-direction: column;justify-content: center;  font-family: verdana;"><span>PHOTO PRECAST  CONCRETE STRUCTURES</span></h3>                                    
                                </div>
                            </a>
                        </div>
        ...
        <div class="modal event-modal" id="myModal11" style="background-image: url(assets/img/events/IARC.jpg); background-size: cover;">
        <div class="modal-dialog"> 
            <div class="modal-content" >
              <div class="modal-header">
                <button type="button" style="color: white;opacity: 1;" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><span style="  font-family: verdana;">SUPPORT SYSTEM ON DEEP EXCAVATION AND UNDERGROUND STRUCTURES </span></h4>
              </div>
              <div>
  ...
  <div class="tab-content">
        <div class="tab-pane fade in active" id="tab61">
          <p><b>“At times , a building will burrow into the ground like a rabbit and at other times it soars like a bird”</b>
              <b>“Underground! A more gentle way to built”</b>
</p>
        <p>Ever wondered what is happening beneath us?? Ever wondered of dwelling with ground as the roof?? From residential extensions to public transport to Bank vaults,there is a lot going on under our cities.With surface being cramped ,there is nowhere to go ,but down.It is up to us,civil engineers, to“dig deep”for alternative solutions, exploring underground-The spectacle of invisible.</p>
        <p><b>CIVILISATION 17</b> is delighted to give you the best opportunity to explore procurement , design and delivery of underground structures under the topic <b>“SUPPORT SYSTEM ON DEEP EXCAVATION AND UNDERGROUND STRUCTURES”.</b></p>
        ...
        <div class="tab-pane fade" id="tab63">
                ...
                <h3><u>DETAILS:</u></h3>
                <p>DATE : 16TH March,2017<br \>
TIME: 9:30 am to 12:30 pm<br \>
VENUE:CEG<br \>
REGISTRATION FEE: INR 550</p>
        ...
        <div class="tab-pane fade" id="tab66">
            ...
            <h4>Lecture session: 3hrs(9:30 to 12:30)
            </h4>
            <p>Session 1 by<br \>
               Dr N Kumar Pitchumani,CEng,MICE,<br \>
                Technical Director- Geotechnical,<br \>
                AECOM.
</p>
...
<p>Session 2 by<br \>
    Dr Venkata Prasad Chintaluri,<br \>
    Managing Director,<br \>
    M/s Geo Marine Consultant (P) Ltd.,
...
Vinitha - 8754094512<br \>
Yogeswaran - 9790191669<br \>
Email at <b><u>workshop@civilisation.org.in</u></b>
</p>

      </div>
    <!--  <div class="tab-pane fade" id="tab65">Contact Details
<ul>
            <li>Pawan - 9453994806</li>
...
<section id='talksy' style="background-color: #ebedf1;" >
      <div class="container" >
        		<div class="row">
        			<div class="col-lg-12 text-center" data-scrollreveal="move 0">
                        <h2 class='glows'>GUEST LECTURERS</h2>
                        <hr class="primary">
                    </div>
                </div>
       <div class="row">
                                ...
                                <div class="item active">
                                    <div class="col-md-4">
                                        <div style="background-color: white;padding: 10px;border-radius: 5px;" data-toggle="modal" data-target="#ahemdabad_speaker" class="text-center speaker">
                                              <a href="#aboutModal" data-toggle="modal"><img src="talks/yash_s.jpg" width="100%"></a>
                                               <h3>Yash Shah</h3>
                                               <em>Chief Executive</em><br><hr>
                                               <p>@Gridle - Productivity Platform for Work<br></p>
                                               <h3>City: <strong>AHMEDABAD</strong></h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="col-md-4">
                                        <div style="background-color: white;padding: 10px;border-radius: 5px;" data-toggle="modal" data-target="#jaipur_speaker" class="text-center speaker">
                                              <a href="#aboutModal" data-toggle="modal"><img src="talks/anand_s.jpg" width="100%"></a>
                                               <h3>Anand singh shekhawat</h3>
                                               <em>Founder & CEO</em><br><hr>
                                               <p>@Tourepedia - Leisure, Travel & Tourism<br></p>
                                               <h3>City: <strong>JAIPUR</strong></h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="col-md-4">
                                        <div style="background-color: white;padding: 10px;border-radius: 5px;" data-toggle="modal" data-target="#bhopal_speaker" class="text-center speaker">
                                              <a href="#aboutModal" data-toggle="modal"><img src="talks/deepak_s.jpg" width="100%"></a>
                                               <h3>Dr. Deepak Motwani</h3>
                                               <em>Founder @ I.T. Fusion and Vishleshan Educational and Social Welfare Society - VESWS</em><hr>
<!--                                                <p>Socialpreneur at Vishleshan Educational & Social Welfare Society<br></p>
 -->                              <!--                 <h3>City: <strong>BHOPAL</strong></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="tab-pane active" id="about_1">
                                                        <div class="modal-header">
													        <button type="button" class="close" data-dismiss="modal">✕</button>
                                                             ...
                                                             <img src="talks/yash.jpg" width="100%">
                                                              <h3>Yash Shah</h3>
                                                             ...
                                                             <div>
                                                               <h2>About Speaker</h2>
                                                               <p>Yash did his Mechanical Engineering from NIT-S where he also became a Kairos fellow and an MITx Bootcamper. He later worked as an investment banker with a nationalized bank and founded Gridle, a productivity suite for enterprises where he today serves as its chief executive officer. He currently sits on mentor board of NIT-Surat, VGEC and Silver Oak College of Engineering and Technology. He blogs at yashshah.in and is a guest author at Yourstory & The Tech Panda.</p>
                                                             </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="tab-pane active" id="about_1">
                                                         <div class="modal-header">
													        <button type="button" class="close" data-dismiss="modal">✕</button>
                                                             ...
                                                             <img src="talks/anand.jpg" width="100%">
                                                              <h3>Anand singh shekhawat</h3>
                                                             <em>Founder & CEO</em>
                                                             <p>@Tourepedia - Leisure, Travel & Tourism<br></p>
                                                             <hr>
                                                             <div>
                                                               <h2>About Speaker</h2>
                                                               <p>Tourepedia, A travel organisation offers wide range of tours and activities to impart ultimate travel experience to families, couples, friends group, corporate and schools/colleges students. 
...
Tourepedia organises wide range of trips like family trips,honeymoon trips, educational trips, corporate trips, group trips etc. and activities such as trekking, national park safaris, biking, scuba diving, rafting, camping etc to cater the needs of adventure and experience lovers, in incredible India.</p>
                                                             </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <div class="modal event-modal" id="myModal1234" style="background-image: url(assets/img/events/Manoeuvre.jpg); background-size: cover;">
        <div class="modal-dialog"> 
            <div class="modal-content" >
              <div class="modal-header">
  ...
  <div class="tab-content">
        <div class="tab-pane fade in active" id="tab71">
          <ul>
                ...
                <li>Rs.200 per day will be collected as a accommodation fee.</li>
                <li>Rs.500 will be collected for those who stay all 3 days.</li>
                <li>Since accommodation is provided at college hostel, students should obey the rules and regulation during the stay.</li>
                <li>Door locks will be provided for rooms.</li>
...
<ul><li>9943911352 (KARTHIKEYAN.S)</li>
  		...
  		<div class="modal event-modal" id="myModal22" style="background-image: url(assets/img/events/Manoeuvre.jpg); background-size: cover;">
    		<div class="modal-dialog"> 
      			<div class="modal-content" >
      				<div class="modal-header">
        				<button type="button" class="close" style="color: white;opacity: 1;" data-dismiss="modal" style="font-size: 200%;">&times;</button>
        				<h4 class="modal-title"><span style="  font-family: verdana;">PHOTO PRECAST STRUCTURES</span></h4>
      				</div>
        			<div>
...
<div class="container-fluid">
  <div class="row contact-col">
    ...
    <div class="col-sm-3 col-md-6">
                                    <h3>Prof. Dr. Kurian Joseph</h3>
                                    <p>CES,Anna University.President<br \>
                                    Society of Civil Engineers.</p>
    </div>
    <div class="col-sm-9 col-md-6">
                                    <h3>Dr. G. Dhinagaran Asst.Prof</h3>
                                    <p>CES,Anna university,Treasurer<br \>
                                    Society of Civil Engineers.</p>
    </div>
    ...
    <div class="col-sm-9 col-md-6">
      <h3>Mr. S. Bharathi</h3>
                                    <p>Joint Secretary</p>
                                    <p>Society of Civil Engineers.<br \>
                                    Phone : +91 7200708762</p>
    </div>
  </div>
</div>
...
<div class="container-fluid">
  <div class="row contact-col">
    <div class="col-sm-3 col-md-6">
          <div class="col-sm-3 col-md-6 cont">
               <img src="sponsor/a5.jpg" width="90%" height="100%">
          </div>
          <div class="col-sm-9 col-md-6 cont">
               <img src="sponsor/a3.jpg" width="90%">
          </div>
          ...
          <div class="col-sm-3 col-md-6">
              ...
              <div class="col-sm-9 col-md-6">
                   <img src="sponsor/a7.jpg" width="90%">
              </div>
